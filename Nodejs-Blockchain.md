...
* Each client will have it's own instance of the orderbook.
* Clients submit orders to their instance of orderbook. The order is distributed to other instances too.
* If a client's order matches with an another order, the result is also added to the orderbook too.

Requirement:
* Use Grenache for communication between nodes
* Simple order matching engine.
* You don't need to create a UI.
